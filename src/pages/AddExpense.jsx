...
export const AddExpense = () => {
  ...
  const [expenseDate, setExpenseDate] = useState('2026-08-10');
  ...
  const handleSubmit = (e) => {
    ...
    const formData = { category: targetCategory, description, amount, expenseDate };
  ...
  return (
    <PageContainer title="Add Business Expense" breadcrumb="Expenditure / Add Expense">
      <div style={{ marginBottom: '1.5rem' }}>
        <button className="btn btn-secondary btn-sm" onClick={() => navigate('/expenditure')} style={{ marginBottom: '0.75rem' }}>
          <ArrowLeft size={16} /> Back to Expenses
        </button>
        <h2 style={{ fontSize: '1.25rem', fontWeight: 700 }}>Record Operational Expense</h2>
      </div>
